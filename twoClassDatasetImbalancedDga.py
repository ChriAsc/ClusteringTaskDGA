...
imbalanced_dga_v1 = spark.createDataFrame([], schema)
imbalanced_dga_v2 = spark.createDataFrame([], schema)
...
#dataset_writer(f"{os.environ['HOME']}/progettoBDA/datasets/DGAMajorityBalancedDGA.csv",
#               final_imbalanced_v1, mode='w')
# dataset_writer(f"{os.environ['HOME']}/progettoBDA/datasets/DGAMajorityImbalancedDGA.csv",
